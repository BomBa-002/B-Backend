...
const file = (name, level) => new DailyRotateFile({ filename: path.join(logDir, `${name}-%DATE%.log`), datePattern: 'YYYY-MM-DD', maxFiles: `${process.env.LOG_RETENTION_DAYS ?? 14}d`, level, format });
