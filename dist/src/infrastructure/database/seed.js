...
const run = sqlite.transaction(() => {
    ...
    for (const [code, name, type] of [['1000', 'الأصول', 'asset'], ['2000', 'الالتزامات', 'liability'], ['3000', 'حقوق الملكية', 'equity'], ['4000', 'الإيرادات', 'revenue'], ['5000', 'المصروفات', 'expense']])
        account.run(randomUUID(), tenantId, code, name, type, now, now);
