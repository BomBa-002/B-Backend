...
export const errors = {
    validation: (details) => new AppError('2.1.1', 'البيانات اللي اتبعتت مش مظبوطة', 400, details, 'VALIDATION'),
    ...
    conflict: (message) => new AppError('5.2.1', message, 409, undefined, 'BUSINESS'),
